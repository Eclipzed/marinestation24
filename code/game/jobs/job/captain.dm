...
//		H.equip_to_slot_or_del(new /obj/item/clothing/glasses/sunglasses(H), slot_glasses)
		if(istype(H, /mob/living/carbon/human/vox))
			...
			H.equip_to_slot_or_del(new /obj/item/clothing/suit/space/vox/stealth(H), slot_in_backpack)
			H.equip_to_slot_or_del(new /obj/item/clothing/head/helmet/space/vox/stealth(H), slot_in_backpack)
